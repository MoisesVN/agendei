...
ALTER TABLE `UsuarioTomador` ADD CONSTRAINT `UsuarioTomador_fk0` FOREIGN KEY (`id_Pessoa`) REFERENCES `Pessoa`(`CPF`);

ALTER TABLE `UsuarioPrestador` ADD CONSTRAINT `UsuarioPrestador_fk0` FOREIGN KEY (`id_Pessoa`) REFERENCES `Pessoa`(`CPF`);
